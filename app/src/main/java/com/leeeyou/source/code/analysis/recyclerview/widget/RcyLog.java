package com.leeeyou.source.code.analysis.recyclerview.widget;
...
public class RcyLog {
    ...
    public static void loaAllCache(TextView tv, RecyclerView rcy) {
        try {
            ...
            builder.append("当前Pool中的ViewHolder的数量：").append(recycledViewPool.getRecycledViewCount(0)).append("\n");
